...
CREATE TABLE consultant (
  ...
  consultant_file_type varchar(200) COLLATE utf8_bin DEFAULT NULL,
  consultant_file_size int(11) DEFAULT NULL,
  consultant_consent_form varchar(50) DEFAULT NULL,
  consultant_box_file_id bigint(20) DEFAULT NULL,
  consultant_quarter_created int(11) DEFAULT NULL,
  consultant_date_created timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE context (
  ...
  context_spatial_point geometry DEFAULT NULL,
  context_quarter_created int(11) DEFAULT NULL,
  context_date_created timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE data (
  ...
  data_file_type varchar(200) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  data_file_size int(11) DEFAULT NULL,
  data_file varchar(50) DEFAULT NULL,
  data_box_file_id bigint(20) DEFAULT NULL,
  data_quarter_created int(11) DEFAULT NULL,
  data_date_created timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (data_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE collector_quarter (
  ...
  UNIQUE KEY collector_quarter (collector_id, quarter_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE quarter (
  ...
  UNIQUE KEY quarter_short_name (quarter_short_name)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
